...
class CatTest {
    ...
    void die() {
        Cat barlow = new Cat();
        barlow.die();
        String expected = "Cat{name='Felix', isDead=true}";
        String actual = barlow.toString();
        assertTrue(expected.equals(actual),"Expected:\n"+expected+"\n\nActual:\n"+actual);
        Cat panda = new Cat();
        panda.die();
        expected = "Cat{name='Felix', isDead=true}";
        actual = panda.toString();
        assertTrue(expected.equals(actual),"Expected:\n"+expected+"\n\nActual:\n"+actual);
    }
}